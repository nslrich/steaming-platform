      ...
      <div className='flex flex-col grow'>
        ...
        <div className='flex flex-col mb-2'>
          ...
          <div className='flex flex-row gap-2'>
            <input type="text" disabled={true} name="movie_location" id="movie_location" placeholder="C:\..." value={movieLocation} className="block w-full rounded-md border-2 py-1.5 px-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-gray-300 sm:text-sm sm:leading-6 disabled:bg-white" />
        ...
        <div className='flex flex-col mb-2'>
          ...
          <div className='flex flex-row gap-2'>
            <input type="text" disabled={true} name="show_location" id="show_location" placeholder="C:\..." value={showLocation} className="block w-full rounded-md border-2 py-1.5 px-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-gray-300 sm:text-sm sm:leading-6 disabled:bg-white" />
